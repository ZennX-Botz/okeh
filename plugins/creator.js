...
let name = await conn.getName(who)
 ...
 const ini = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `⁨flawzx@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://chat.whatsapp.com/KNkpoT4oX5yFA18GlPttgl`],
    [`${conn.user.jid.split('@')[0]}`, `${await conn.getName(conn.user.jid)}`, `🔥 Bot WhatsApp 🐣`, `📵 Don't spam/call me 😢`, `Nothing`, `🇮🇩 Indonesia`, `🚀 https://chat.whatsapp.com/KNkpoT4oX5yFA18GlPttgl`, `🤖 Dont Forget To Donate!`]
  ], fkontak)
